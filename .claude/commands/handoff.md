...
After providing your analysis and summary, write the handoff summary to a markdown file at `我们的文档/开放文档/CN/CN-000xx-[slug].md` where [timestamp] is the current date in format YYYY-MM-DD and the slug is what we defined before.
