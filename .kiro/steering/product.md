...
- **技术栈**: Gradle 8.7, Kotlin 2.0.21 (K2编译器), AGP 8.7.3, Compose BOM 2024.12.01, Hilt 2.52, Room v16
...
| BUG-00070 | 悬浮球在App内不显示问题 | 已修复 |
| BUG-00071 | 截图权限持久化与策略调整 | 已修复 |
| BUG-00073 | OPPO真机悬浮球不显示问题 | 进行中 |
