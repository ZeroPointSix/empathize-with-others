...
### 模块文件统计（2026-01-04最新扫描）

| 模块 | 主源码 | 单元测试 | Android测试 | 禁用测试 | 总计 | 测试覆盖率 |
|------|--------|---------|------------|---------|------|-----------|
| **:domain** | 200+ | 157 | 0 | 0 | 357+ | 高覆盖率 |
| **:data** | 70+ | 28 | 20 | 0 | 118+ | 40.7% |
| **:presentation** | 100+ | 30 | 0 | 0 | 130+ | 中覆盖率 |
| **:app** | 25 | 18 | 1 | 0 | 44 | 高覆盖率 |
| **总计** | **544** | **233** | **36** | **0** | **813** | **~45%** |

**项目整体统计**：
- 总Kotlin文件数：813个
- 主源码文件：544个
- 测试文件：269个（233单元 + 36Android）

### 架构合规性
- **Clean Architecture**: ⭐⭐⭐⭐⭐ (A级，完全合规)
- **模块化**: ⭐⭐⭐⭐⭐ (A级，4模块架构)
- **依赖方向**: ⭐⭐⭐⭐⭐ (A级，严格单向依赖)
- **测试覆盖**: ⭐⭐⭐⭐☆ (B级，~45%总覆盖率，269个测试文件)

---

**文档版本**: 2.4
**最后更新**: 2026-01-04
**更新内容**: 基于最新代码扫描结果更新项目统计信息（544主源码 + 269测试 = 813总文件）
