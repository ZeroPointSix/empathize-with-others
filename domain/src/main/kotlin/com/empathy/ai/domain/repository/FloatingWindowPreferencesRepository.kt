...
/**
 * Floating window preferences repository interface
 *
 * Abstracts floating window state persistence, following Clean Architecture principles
 * Presentation layer accesses floating window preferences through this interface
 */
