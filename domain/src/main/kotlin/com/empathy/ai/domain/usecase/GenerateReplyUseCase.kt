 ...
 * @see TD-00013 自己画像界面任务清单 - 回复模式用户画像集成修复
 */
class GenerateReplyUseCase @Inject constructor(
    ...
    companion object {
        private const val TAG = "GenerateReplyUseCase"
    }
    ...
    suspend operator fun invoke(
        ...
        return try {
            ...
            val userProfileContext = try {
                userProfileContextBuilder.buildAnalysisContext(profile, theirMessage)
                    .getOrNull() ?: ""
            } catch (e: Exception) {
            ...
            val runtimeData = buildRuntimeData(prefixedMessage, redTags, greenTags, profile, historyContext, userProfileContext)
