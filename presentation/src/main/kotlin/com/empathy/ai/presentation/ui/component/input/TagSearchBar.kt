...
@Composable
private fun TagSearchBarEmptyPreview() {
    EmpathyTheme {
        TagSearchBar(
            searchQuery = "",
            resultCount = 0,
...
@Composable
private fun TagSearchBarWithQueryPreview() {
    EmpathyTheme {
        TagSearchBar(
            searchQuery = "工作",
            resultCount = 5,
...
@Composable
private fun TagSearchBarNoResultsPreview() {
    EmpathyTheme {
        TagSearchBar(
            searchQuery = "不存在的标签",
            resultCount = 0,
...
@Composable
private fun TagSearchBarDarkPreview() {
    EmpathyTheme {
        TagSearchBar(
            searchQuery = "策略",
            resultCount = 3,
