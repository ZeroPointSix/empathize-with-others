...
| 工作树路径 | 分支 | 状态 | 说明 |
|---|---|---|---|
| `E:/项目的创建者/Data-code/Love` | `main` | 活跃 | 主分支，基础代码库 |
| `E:/项目的创建者/Data-code/EnsoAi/Love/freedom` | `freedom` | 活跃 | 自由探索分支，包含联系人搜索高亮等优化 |
| `E:/项目的创建者/Data-code/EnsoAi/Love/PRD36-picture` | `PRD36-picture` | 活跃 | 当前管理工作树 |
