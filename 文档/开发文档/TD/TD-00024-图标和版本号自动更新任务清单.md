...
|------|------|----------|--------|----------|--------|
| Phase 1 | ⏳ 待开始 | 0/9 | 9 | 15h | 0% |
| Phase 2 | ⏳ 待开始 | 0/6 | 6 | 11.5h | 0% |
| Phase 3 | ⏳ 待开始 | 0/8 | 8 | 14h | 0% |
| Phase 4 | ⏳ 待开始 | 0/6 | 6 | 10h | 0% |
| Phase 5 | ⏳ 待开始 | 0/9 | 9 | 15h | 0% |
| Phase 6 | ⏳ 待开始 | 0/4 | 4 | 9h | 0% |
| **总计** | **⏳ 待开始** | **0/42** | **42** | **74.5h** | **0%** |
...
|------|----------|----------|----------|----------|------|
| Phase 1: 基础架构搭建 | 9 | 15h | 2天 | 低 | ⏳ 待开始 |
| Phase 2: 版本管理实现 | 6 | 11.5h | 1.5天 | 低 | ⏳ 待开始 |
| Phase 3: 图标管理实现 | 8 | 14h | 2天 | 中 | ⏳ 待开始 |
| Phase 4: 备份与错误处理 | 6 | 10h | 1.5天 | 低 | ⏳ 待开始 |
| Phase 5: Gradle任务集成 | 9 | 15h | 2天 | 中 | ⏳ 待开始 |
...
- [ ] T015 (3h) [Phase3] 实现IconManager图标管理器
...
- [ ] T016 (2.5h) [Phase3] 实现InitIconResourcesTask图标初始化任务
...
- [ ] T017a (2h) [Phase3] 编写IconManager单元测试
  - 创建 `IconManagerTest.kt` 测试类
  - 测试图标切换功能
  - 测试图标映射配置加载
  - _需求: TDD-00024 6.1 单元测试_

- [ ] T017b (1h) [Phase3] 编写IconManager边界测试
  - 测试图标文件不存在时的处理
  - 测试图标文件损坏时的处理
  - 测试无效阶段参数的处理
  - 测试目标目录权限不足时的处理
...
- [ ] T018 (3h) [Phase4] 实现BackupManager备份管理器
...
- [ ] T019 (1.5h) [Phase4] 定义VersionUpdateError错误类型
...
- [ ] T021 (2h) [Phase4] 编写Phase 4单元测试
  - 创建 `BackupManagerTest.kt` 测试类
  - 测试备份创建和恢复功能
  - 测试错误处理和回滚逻辑
  - _需求: TDD-00024 6.1 单元测试_

- [ ] T021a (1.5h) [Phase4] 编写BackupManager边界测试
  - 测试磁盘空间不足时的处理
  - 测试备份文件损坏时的处理
  - 测试并发备份操作的处理
  - 测试备份目录权限不足时的处理
...
- [ ] T022 (3h) [Phase5] 实现VersionUpdatePlugin插件入口
...
- [ ] T023 (3h) [Phase5] 实现UpdateVersionAndIconTask主任务
...
- [ ] T026 (2.5h) [Phase5] 编写Phase 5集成测试
...
- [ ] T027 (2h) [Phase6] 创建GitHub Actions工作流
...
### Phase 5 验证
- [ ] Gradle任务注册成功
- [ ] `./gradlew updateVersionAndIcon --dry-run` 执行成功
- [ ] `./gradlew showCurrentVersion` 显示正确版本
- [ ] `./gradlew initIconResources` 初始化图标资源成功
