...
| 2026-01-10 | `adb -s 192.0.2.1:7555 install -r app/build/outputs/apk/debug/app-debug.apk` | 通过 | MuMu 安装成功 |
| 2026-01-10 | `adb -s 192.0.2.1:7555 shell am start -n com.empathy.ai/.ui.MainActivity` | 通过 | 启动 MainActivity 成功 |
| 2026-01-10 | `adb -s 192.0.2.1:7555 logcat -d` | 通过 | 仅见系统/渲染日志，无明显崩溃栈 |
| 2026-01-10 | `adb -s 192.0.2.1:7555 logcat -c` | 通过 | 清空日志，等待人工验收 |
| 2026-01-10 | `adb -s 192.0.2.1:7555 logcat -d` | 通过 | 当前未输出 `com.empathy.ai` 日志（可能未执行手动用例或日志被过滤） |
